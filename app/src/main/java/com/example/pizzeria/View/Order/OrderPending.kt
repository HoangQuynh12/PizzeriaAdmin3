...
class OrderPending : ComponentActivity() {
        ...
        setContent {
            PizzeriaTheme {
                Surface(
                    ...
                    dbPending.whereEqualTo("status", "Pending").get().addOnSuccessListener { queryDocumentSnapshot ->
                    ...
                    PendingScreen(context, pendingList)
                }
            }
        }
    }
